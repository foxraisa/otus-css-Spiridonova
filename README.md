...
Для работы с проектом использовался  Visual Studio Code.
...
## Работа в ветках 
Работа над секциями велась в одноименных ветках. Все ветки смержины в main, кроме одной strong-points-section, где добавлены стили @supports. 
...
## Защита 
Защита будет проходить 16.01.2025
Требуется подготовить презентацию проектаПодготовка будет происходить 14.01.2025
